  ...
  return (
    <section id="skills" className="min-h-screen pt-32 pb-16 flex flex-col justify-center border-b border-border">
      ...
      <div className="mb-8 border-l-4 border-tertiary pl-8 mx-[10%]">
        ...
        <div className="font-display text-xs text-tertiary mt-2">SYSTEM_MODULES // LEVEL_10</div>
      </div>
      ...
      <div className="w-full overflow-x-auto pb-8 custom-scrollbar">
        <div className="relative min-w-[900px] max-w-[1200px] h-[600px] mx-auto">
          ...
          {/* GLOWING CONNECTING LINES (Fixed using <line> tags for % support) */}
          <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
            <g stroke="var(--color-tertiary)" strokeWidth="2" strokeDasharray="8 8" className="opacity-80 drop-shadow-[0_0_5px_var(--color-tertiary)]">
              
              {/* PHP Node Routing */}
              <line x1="50%" y1="50%" x2="50%" y2="40%" />
              <line x1="50%" y1="40%" x2="12%" y2="40%" />

              {/* WEB_DEV Node Routing */}
              <line x1="50%" y1="50%" x2="50%" y2="38%" />
              <line x1="50%" y1="38%" x2="30%" y2="38%" />

              {/* REACT Node Routing */}
              <line x1="50%" y1="50%" x2="50%" y2="15%" />
              <line x1="50%" y1="15%" x2="15%" y2="15%" />

              {/* JAVASCRIPT Node Routing */}
              <line x1="50%" y1="50%" x2="50%" y2="12%" />
              <line x1="50%" y1="12%" x2="35%" y2="12%" />
          ...
          {nodes.map((node) => (
            ...
            >
              ...
              <div className="absolute inset-[2px] bg-[#050505] group-hover:bg-[#111] transition-colors [clip-path:polygon(14px_0,100%_0,100%_calc(100%-14px),calc(100%-14px)_100%,0_100%,0_14px)] flex flex-col items-center justify-center p-2">
                ...
                <div className="text-muted font-display text-xs mt-1 flex flex-col gap-1 items-center">
                  <span>LVL {node.lvl}</span>
                  <span className="text-[0.65rem] text-accent italic">
                    {node.subtitle}
                  </span>
                </div>
              </div>
